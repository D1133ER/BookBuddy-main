        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="mb-8">
            ...
            <div className="mt-4 rounded-xl border border-primary/15 bg-primary/5 p-3 text-sm text-slate-700">
              ...
              <p className="mt-1">Use Maya's seeded community account to test requests, messaging, and returns locally.</p>
              <Button type="button" variant="outline" className="mt-3 h-9 rounded-lg" onClick={fillDemoCredentials}>
                Use demo account
              </Button>
            </div>
          </div>
          ...
          <div className="mt-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full h-11 rounded-xl text-base font-medium" disabled={isLoading}>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Link to="/register">
                  <Button variant="outline" className="w-full h-11 rounded-xl font-medium border-gray-200 text-gray-700 hover:bg-gray-50">
                    Create an account
                  </Button>
                </Link>
              </div>
      ...
      <div className="hidden lg:block relative w-0 flex-1 bg-gray-50">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-16 text-white">
          ...
          <p className="max-w-xl text-lg text-white/95">
            Join thousands of readers in your local community who are sharing their favorite books, discovering new authors, and building lasting connections through literature.
          </p>
        </div>
      </div>
      </main>
